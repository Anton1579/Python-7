...
# значения до целого числа.Сложение. Объединение двух клеток. При этом число ячеек
# общей клетки должно равняться сумме ячеек исходных двух клеток.Вычитание.
...
class Cell():
    ...
    def __init__(self, make_order):
        self.make_order = make_order

    def __str__(self):
        return str(f'Общее количество клеток - {self.make_order}')

    def __add__(self, n):
        return f'Количество клеток после сложение - {self.make_order + n}'

    def __sub__(self, n):
        return f'Количество клеток после вычитания - {self.make_order - n}'

    def __mul__(self, n):
        return f'Количество клеток после умножение - {self.make_order * n}'

    def __truediv__(self, n):
        return f'Количество клеток после деление - {round(self.make_order / n, 0)}'
